...
import { paroData } from '../components/region/paro';
import { ThimphuData } from '../components/region/thimphu';
import { DaganaData } from '../components/region/dagana';
import { bumthangData } from '../components/region/bumthang';
import { ChhukhaData } from '../components/region/chhukha';
import { gasagData } from '../components/region/gasa';
import { haData } from '../components/region/ha';
import { lhuentseData } from '../components/region/lhuentse';
import { monggarData } from '../components/region/monggar';
import { pemagatshelData } from '../components/region/pemagatshel';
import { punakhaData } from '../components/region/punakha';
import { samdrup_jongkhagData } from '../components/region/samdrup_jongkhar';
import { SamtseData } from '../components/region/samtse';
import { sarpangData } from '../components/region/sarpang';
import { trashigangData } from '../components/region/Trashigang';
import { trashiyangtsheData } from '../components/region/trashiyangtshe';
import { trongsaData } from '../components/region/trongsa';
import { TsirangData } from '../components/region/tsirang';
import { wangdue_phodrangData } from '../components/region/wangdue_phodrang';
import { zhemgangData } from '../components/region/zhemgang';
...
// import BumthangPattern from "../assets/textile_patterns/bumthang_pattern.svg";
// import ChhukhaPattern from "../assets/textile_patterns/pumo_pattern.svg";
// import DaganaPattern from "../assets/textile_patterns/pumo_pattern.svg";
// import GasaPattern from "../assets/textile_patterns/bumthang_pattern.svg";
// import HaaPattern from "../assets/textile_patterns/haa_pattern.svg";
// import LhuentsePattern from "../assets/textile_patterns/lhuentse_pattern.svg";
// import MongarPattern from "../assets/textile_patterns/pumo_pattern.svg";
// import ParoPattern from "../assets/textile_patterns/paro_pattern.svg";
// import PemagatshelPattern from "../assets/textile_patterns/lhuentse_pattern.svg";
// import PunakhaPattern from "../assets/textile_patterns/pumo_pattern.svg";
// import SamdrupJongkharPattern from "../assets/textile_patterns/pumo_pattern.svg";
// import SamtsePattern from "../assets/textile_patterns/pumo_pattern.svg";
// import SarpangPattern from "../assets/textile_patterns/pumo_pattern.svg";
// import ThimphuPattern from "../assets/textile_patterns/lhuentse_pattern.svg";
// import TrashigangPattern from "../assets/textile_patterns/paro_pattern.svg";
// import TrashiyangtsePattern from "../assets/textile_patterns/haa_pattern.svg";
// import TrongsaPattern from "../assets/textile_patterns/haa_pattern.svg";
// import TsirangPattern from "../assets/textile_patterns/haa_pattern.svg";
// import WangduePhodrangPattern from "../assets/textile_patterns/wangdue_phodrang_pattern.svg";
// import ZhemgangPattern from "../assets/textile_patterns/zhemgang_pattern.svg";
// import { SvgProps } from 'react-native-svg';

// // Define the structure for a single textile item
// export interface Textile {
...
// };
// // Placeholder textile data - this will be moved into each region object
// const placeholderTextiles = {
//   paro: [
//     { id: 'paro-t1', name: 'Paro Textile Alpha', color: '#E34234', detailPage: '/textiles/paro-t1' },
//     { id: 'paro-t2', name: 'Paro Textile Beta', color: '#FAD02C', detailPage: '/textiles/paro-t2' },
//   ],
//   chhukha: [
//     { id: 'chhukha-t1', name: 'Chhukha Weave 1', color: '#4CAF50', detailPage: '/textiles/chhukha-t1' },
//     { id: 'chhukha-t2', name: 'Chhukha Weave 2', color: '#2196F3', detailPage: '/textiles/chhukha-t2' },
//   ],
//   ha: [
//     { id: 'ha-t1', name: 'Ha Pattern X', color: '#FF9800', detailPage: '/textiles/ha-t1' },
//     { id: 'ha-t2', name: 'Ha Pattern Y', color: '#9C27B0', detailPage: '/textiles/ha-t2' },
//   ],
//   punakha: [
//     { id: 'punakha-t1', name: 'Punakha Royal', color: '#795548', detailPage: '/textiles/punakha-t1' },
//     { id: 'punakha-t2', name: 'Punakha Silk', color: '#FFEB3B', detailPage: '/textiles/punakha-t2' },
//   ],
//   samtse: [
//     { id: 'samtse-t1', name: 'Samtse Border Art', color: '#607D8B', detailPage: '/textiles/samtse-t1' },
//     { id: 'samtse-t2', name: 'Samtse Flora', color: '#8BC34A', detailPage: '/textiles/samtse-t2' },
//   ],
//   thimphu: [
//     { id: 'thimphu-t1', name: 'Thimphu Ceremonial', color: '#F44336', detailPage: '/textiles/thimphu-t1' },
//     { id: 'thimphu-t2', name: 'Thimphu Modern', color: '#00BCD4', detailPage: '/textiles/thimphu-t2' },
//     { id: 'thimphu-t3', name: 'Thimphu Heritage', color: '#FFC107', detailPage: '/textiles/thimphu-t3' },
//   ],
//   tsirang: [
//     { id: 'tsirang-t1', name: 'Tsirang Stripe', color: '#3F51B5', detailPage: '/textiles/tsirang-t1' },
//     { id: 'tsirang-t2', name: 'Tsirang Diamond', color: '#009688', detailPage: '/textiles/tsirang-t2' },
//   ],
//   dagana: [
//     { id: 'dagana-t1', name: 'Dagana Earth Tone', color: '#A1887F', detailPage: '/textiles/dagana-t1' },
//     { id: 'dagana-t2', name: 'Dagana Sky Blue', color: '#03A9F4', detailPage: '/textiles/dagana-t2' },
//   ],
//   wangdue_phodrang: [
...
//   ],
//   gasa: [
//     { id: 'gasa-t1', name: 'Gasa Laya Wool', color: '#A0522D', detailPage: '/textiles/gasa-t1' },
...
//   ],
//   sarpang: [
//     { id: 'sarpang-t1', name: 'Sarpang Tribal', color: '#6A5ACD', detailPage: '/textiles/sarpang-t1' },
//     { id: 'sarpang-t2', name: 'Sarpang Geometric', color: '#20B2AA', detailPage: '/textiles/sarpang-t2' },
//     { id: 'sarpang-t3', name: 'Sarpang Border', color: '#FFA500', detailPage: '/textiles/sarpang-t3' },
//   ],
//   trongsa: [
...
//   ],
//   trashiyangtshe: [
//     { id: 'ty-t1', name: 'Trashi Yangtse Traditional', color: '#9400D3', detailPage: '/textiles/ty-t1' },
//     { id: 'ty-t2', name: 'Yangtse Wool', color: '#00CED1', detailPage: '/textiles/ty-t2' },
//     { id: 'ty-t3', name: 'Eastern Pattern', color: '#FF1493', detailPage: '/textiles/ty-t3' },
//   ]
...
//         , textiles: placeholderTextiles.paro,
//         labelX: 630,
//     labelY: 40, 
...
//  , textiles: placeholderTextiles.chhukha,
//     labelX: 160,
//     labelY: 300,
...
// ,textiles: placeholderTextiles.ha,
//     labelX: 80,
//     labelY: 200,
...
// , textiles: placeholderTextiles.punakha,
//     labelX: 280,
//     labelY: 180,
...
// ,textiles: placeholderTextiles.samtse,
//     labelX: 50,
//     labelY: 300,
...
//          ,  textiles: placeholderTextiles.thimphu,
//     labelX: 200,
//     labelY: 220,
...
// ,  textiles: placeholderTextiles.tsirang,
//     labelX: 280,
//     labelY: 300,
...
//    ,textiles: placeholderTextiles.dagana,
//     labelX: 220,
//     labelY: 280,
...
//      ,textiles: placeholderTextiles.wangdue_phodrang,
//     labelX: 300,
//     labelY: 250,
...
//    , textiles: placeholderTextiles.sarpang,
//     labelX: 300,
//     labelY: 80,
...
//     , textiles: placeholderTextiles.trongsa,
//     labelX: 630,
//     labelY: 40,
...
//    ,textiles: placeholderTextiles.bumthang,
//     labelX: 630,
//     labelY: 40,
...
// , textiles: placeholderTextiles.zhemgang,
//     labelX: 630,
//     labelY: 40,
...
// , textiles: placeholderTextiles.trashigang,
//     labelX: 630,
//     labelY: 40,
...
//      , textiles: placeholderTextiles.monggar,
//     labelX: 300,
//     labelY: 80,
...
//  , textiles: placeholderTextiles.pemagatshel,
//     labelX: 300,
//     labelY: 80,
...
//     , textiles: placeholderTextiles.lhuentse,
//     labelX: 300,
//     labelY: 80,
...
//    , textiles: placeholderTextiles.samdrup_jongkhar,
//     labelX: 300,
//     labelY: 80,
...
//     , textiles: placeholderTextiles.gasa,
//     labelX: 300,
//     labelY: 80,
...
//     , textiles: placeholderTextiles.trashiyangtshe,
//     labelX: 300,
//     labelY: 80,
